...
function imprimir(){
	var papel = window.open('', 'PRINT', 'height=400,width=600');
	
	papel.document.write('<html><head><title>' + document.title + '</title>');
	papel.document.write('</head><body>');
	papel.document.write(document.getElementById("solapa1").innerHTML);
	papel.document.write('</body></html>');
	papel.document.close();
	papel.focus();
	papel.print();
	papel.close();
